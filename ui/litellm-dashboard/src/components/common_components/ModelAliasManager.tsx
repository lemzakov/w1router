    ...
    <div className="mt-4">
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">{t('Target_Model')}</label>
            <ModelSelector
          ...
          <Table className="[&_td]:py-0.5 [&_th]:py-1">
            <TableHead>
              <TableRow>
                ...
                <TableHeaderCell className="py-1 h-8">{t('Target_Model')}</TableHeaderCell>
      ...
      {showExampleConfig && (
        <Card>
          ...
          <Text className="text-gray-600 mb-4">{t('Hereaposs_how_your_current_aliases_would')}</Text>
