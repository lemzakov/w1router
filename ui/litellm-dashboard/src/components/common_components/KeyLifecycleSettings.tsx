  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <span className="text-sm font-medium text-gray-700">{t('Key_Expiry_Settings')}</span>

        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700 flex items-center space-x-1">
            <span>{t('Expire_Key')}</span>
            <Tooltip
      ...
      <div className="space-y-4">
        <span className="text-sm font-medium text-gray-700">{t('AutoRotation_Settings')}</span>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700 flex items-center space-x-1">
              <span>{t('Enable_AutoRotation')}</span>
