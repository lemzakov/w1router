  ...
  return (
    <div className="space-y-6">
      <div className="max-w-3xl">
        <h3 className="text-sm font-medium text-gray-900">{t('Reliability_Retries')}</h3>
        <p className="text-xs text-gray-500 mt-1">{t('Configure_retry_logic_and_failure_handli')}</p>
      </div>
